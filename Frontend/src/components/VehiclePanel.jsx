  ...
  return (
    <div>
        ...
        <div onClick={()=>{
            ...
            props.setVehicleImg('https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_368,w_552/v1555367310/assets/30/51e602-10bb-4e65-b122-e394d80a9c47/original/Final_UberX.png') 
          ...
          <h2 className="text-lg font-semibold mr-2">₹{props.fare.Car}</h2>
        </div>
        ...
        <div onClick={()=>{
            ...
            props.setVehicleImg('https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_368,w_552/v1649231091/assets/2c/7fa194-c954-49b2-9c6d-a3b8601370f5/original/Uber_Moto_Orange_312x208_pixels_Mobile.png') 
        }}className="w-full mb-3 border-2 border-gray-200 active:border-black rounded-2xl flex items-center justify-between p-1">
          ...
          <h2 className="text-lg font-semibold mr-2">₹{props.fare.Bike}</h2>
        </div>
        ...
        <div onClick={()=>{
            ...
            props.setVehicleImg('https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_368,w_552/v1648431773/assets/1d/db8c56-0204-4ce4-81ce-56a11a07fe98/original/Uber_Auto_558x372_pixels_Desktop.png')
        }}className="w-full mb-3 border-2 border-gray-200 active:border-black rounded-2xl flex items-center justify-between p-1">
          ...
          <h2 className="text-lg font-semibold mr-2">₹{props.fare.Auto}</h2>
        </div>
    </div>
  )
}
